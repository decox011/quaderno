...
import { deleteEntity, getEntity } from './note.reducer';
...
export const NoteDeleteDialog = () => {
  ...
  const handleClose = () => {
    navigate(`/note${pageLocation.search}`);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="noteServiceApp.note.delete.question">
        <Translate contentKey="noteServiceApp.note.delete.question" interpolate={{ id: noteEntity.id }}>
