...
import static it.quaderno.note.domain.TagAsserts.*;
...
import it.quaderno.note.repository.search.TagSearchRepository;
...
class TagResourceIT {
    ...
    public static Tag createEntity() {
        return new Tag().name(DEFAULT_NAME).createdAt(DEFAULT_CREATED_AT).updatedAt(DEFAULT_UPDATED_AT);
    }
    ...
    public static Tag createUpdatedEntity() {
        return new Tag().name(UPDATED_NAME).createdAt(UPDATED_CREATED_AT).updatedAt(UPDATED_UPDATED_AT);
    }
    ...
    void putExistingTag() throws Exception {
        ...
        updatedTag.name(UPDATED_NAME).createdAt(UPDATED_CREATED_AT).updatedAt(UPDATED_UPDATED_AT);
    ...
    void partialUpdateTagWithPatch() throws Exception {
        ...
        partialUpdatedTag.createdAt(UPDATED_CREATED_AT).updatedAt(UPDATED_UPDATED_AT);
    ...
    void fullUpdateTagWithPatch() throws Exception {
        ...
        partialUpdatedTag.name(UPDATED_NAME).createdAt(UPDATED_CREATED_AT).updatedAt(UPDATED_UPDATED_AT);
