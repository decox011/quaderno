...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_NOTESHARE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches SEARCH_NOTESHARES actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_NOTESHARE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_NOTESHARE actions', async () => {
      const arg = { id: 31656 };
    ...
    it('dispatches UPDATE_NOTESHARE actions', async () => {
      const arg = { id: 31656 };
    ...
    it('dispatches PARTIAL_UPDATE_NOTESHARE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_NOTESHARE actions', async () => {
      const arg = 42666;
